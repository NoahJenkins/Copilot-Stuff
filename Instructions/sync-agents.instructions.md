---
description: Sync GitHub Copilot instructions into CLAUDE.md, GEMINI.md, and AGENTS.md from the .github source of truth.
applyTo: '**/*'
---
...
<!--
  ...
  ║  To update: run /sync-agent-instructions in Claude Code      ║
  ╚══════════════════════════════════════════════════════════════╝
-->
...
>
> This file is automatically generated by the `/sync-agent-instructions` command.
...
<!--
  ...
  ║  Run /sync-agent-instructions to update path-specific files. ║
  ╚══════════════════════════════════════════════════════════════╝
-->
...
Source of truth: .github/copilot-instructions.md
To keep agents in sync, run /sync-agent-instructions after any Copilot instruction update.
```
